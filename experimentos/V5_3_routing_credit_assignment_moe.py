...
# =========================
# V5.3 — Routing Credit Assignment MoE
# =========================
class V53CreditMoE:
    def __init__(self, input_dim, hidden, output_dim,
        ...
        # Expert performance tracking for pruning
    ...
    def forward(self, X):
        ...
        # soft routing for top-k experts
...
def run():
    ...
    with open("resultados_finais/v5_3_routing_credit_assignment.json", "w") as f:
