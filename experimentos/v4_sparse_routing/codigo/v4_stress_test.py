...
from scripts.bateria_completa import MLPTradicional, make_circles, make_moons, make_spirals, normalize, train_test_split, set_seed, softmax_crossentropy
from experimentos.v4_sparse_routing.codigo.v4_sparse_routing import MLPMultiEstadoV4, get_ms_v4_hidden
