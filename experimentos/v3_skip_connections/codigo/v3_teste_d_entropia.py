...
from scripts.bateria_completa import make_circles, normalize, train_test_split, set_seed, softmax_crossentropy
from experimentos.v3_skip_connections.codigo.v3_skip_mlp_gate import MLPMultiEstadoV3, get_ms_v3_hidden
