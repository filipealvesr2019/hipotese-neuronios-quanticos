...
from bateria_completa import LinearLayer, MLPTradicional, make_circles, normalize, train_test_split, set_seed, softmax_crossentropy
from v4_sparse_routing import compute_entropy, get_ms_v4_hidden
